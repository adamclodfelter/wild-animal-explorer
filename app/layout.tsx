...
export const metadata: Metadata = {
  title: "Kallos Cosmos",
  description: "Every creature tells a story — explore the wonders of creation",
};
      ...
      <body className="min-h-full flex flex-col" style={{ margin: 0, padding: 0, background: "#0f0c29" }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            height: "80px",
            borderRadius: "50%",
            background: "radial-gradient(circle at 35% 35%, #fffde7, #f9a825 60%, #e65100)",
            boxShadow: "0 0 40px 10px rgba(249,168,37,0.25), 0 0 80px 20px rgba(249,168,37,0.1)",
            opacity: 0.85,
          }} />
          ...
          <div style={{
            ...
            <div style={{
              ...
              height: "70px",
              borderRadius: "50%",
              background: "radial-gradient(circle at 38% 35%, #ffe0b2, #ff8f00 55%, #e65100)",
              boxShadow: "0 0 30px 8px rgba(255,143,0,0.2)",
              position: "absolute",
              top: 0,
              left: 0,
            }} />
          ...
          {/* Small distant planet — bottom left */}
          <div style={{
            position: "absolute",
            bottom: "12%",
            left: "8%",
            ...
            height: "28px",
            borderRadius: "50%",
            background: "radial-gradient(circle at 35% 35%, #b2ebf2, #0097a7)",
            boxShadow: "0 0 16px 4px rgba(0,151,167,0.2)",
            opacity: 0.6,
          }} />
